...
function New-StorageAccount{
    ...
    param(
        ...
        # $ipAddress=((Invoke-WebRequest -uri "https://ipinfo.io/json").Content | ConvertFrom-Json).ip
        # Write-Information "This agent public IP is: $ipAddress" -InformationAction Continue
        
        # az storage account network-rule add --$storageAccountName `
